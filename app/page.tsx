    ...
    <div className='flex flex-col justify-center mx-auto lg:max-w-[60%] space-y-10'>
      <div className='flex flex-col space-y-10 md:flex-row justify-center items-center md:space-x-10 md:space-y-0'>
        <div className='border-[5px] rounded-full border-gray-400'>
          <Image src="/Aditya.jpg" alt="Aditya Singh" width={300} height={200} blurDataURL='data:...' placeholder='blur' priority className='rounded-full border-[5px] border-gray-300' />
        </div>
        <div>
      ...
      <Link
        href={"https://drive.google.com/file/d/1C-Zebe8rVQSc08n_ma6BoRyJaZ5qGq3F/view?usp=sharing"}
        target='_blank'
